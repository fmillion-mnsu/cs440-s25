# CS 440 – Topics in Information Management - Syllabus
...
- **Semester/Block**: Spring 2025, Block 5 (3/18/2023 through 5/1/2023), 14 class sessions
- **Days and Time**: Tuesdays and Thursdays, 8:00 AM - 9:50 AM ([iCalendar File](https://github.com/fmillion-mnsu/cs440-s25/raw/master/cs440.ics))
- **Location:** AH 211 ([Building Map](https://www.mnsu.edu/globalassets/maps/university/buildings/2021/ah_02_secondfloor_2021.pdf))
...
This course will explore advanced database and data management systems. We will review traditional SQL-based relational databases, but we will spend most of our time exploring other database systems including document databases, key-value stores, column-family databases, graph databases, and NewSQL.

We will also explore how to connect database systems together and how to build out a complete data management system out of multiple database systems. 

Since there will be exploration of many different systems in a short time, I will be offering you use of our CS server for class projects. Datasets will be preloaded into the servers. You will only need to install local management tools on your machine, and in some cases you may not even need to do that. Details on specific assignments will be given in class.
